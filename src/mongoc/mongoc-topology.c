 ...
 *
 *       Internal function. Track when the socket to a particular server
 *       was last used. This is required for mongoc_cluster_check_interval
 *       to know when a socket has been idle.
 *
 *--------------------------------------------------------------------------
 */
